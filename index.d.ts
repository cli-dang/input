...
declare global {
    ...
    namespace Input {
        ...
        type ARGVtoObject<T> = T extends Input.expectedOptionsTypeProperty & Input.expectedStringProperty ? Input.OptionsType : ParsedArgv

        type ParsedArgv = {
            object: { [p: string]: unknown },
            keys: string[],
            flag?: object | string,
            command?: string,
        ...
        type CommandsDefinition = {
            [command_name: string]: {
                flags?: { [flag_name: string]: FlagDescriptor } | null,
                cb: CommandCallBack,
                rest_args?: RestArgsCallbacks,
                description: string,
                usage: string
        ...
        interface InterfaceCommand {
            ...
            flag( name: string | string[], descriptor: Input.FlagDescriptor ): Promise<void>;
        }
    }

}

export declare class Command implements Input.InterfaceCommand {
